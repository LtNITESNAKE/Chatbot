...
while True:
    ...
    if is_last_message_from_sender(chat_history):
        ...
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are a person named Muhammad Mujtaba who speaks hindi as well as english. You are from pakistan and you are a coder. You analyze chat history and roast people in a funny way. Output should be the next chat response (text message only)"},
